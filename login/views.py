...
def signin(request):
    if request.method =="POST":
        ...
        if user is not None:
            ...
            return(render(request,'.\shop\index.html',{'username':user.username,'id':user.id}))
# D:\\Lucifer-Drive\\Programs\\Django-programs\\Treasure_Box\\Treasure_Box\\templates\\shop\templates\\shop\\index.html'
# D:\Lucifer-Drive\Programs\Django-programs\Treasure_Box\shop\templates\shop\index.html
